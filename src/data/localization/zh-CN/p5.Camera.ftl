...
perspective__description__0 = Sets a perspective projection for a p5.Camera object and sets parameters for that projection according to <a href="#/p5/perspective">perspective()</a> syntax.
ortho__description__0 = Sets an orthographic projection for a p5.Camera object and sets parameters for that projection according to <a href="#/p5/ortho">ortho()</a> syntax.
...
camera__description__0 = Sets a camera's position and orientation. This is equivalent to calling <a href="#/p5/camera">camera()</a> on a p5.Camera object.
