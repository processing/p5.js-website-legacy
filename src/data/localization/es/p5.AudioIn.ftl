...
connect__description__0 = Connect to an audio unit. If no parameter is provided, will connect to the master output (i.e. your speakers).<br/>
...
setSource__description__0 = Set the input source. Accepts a number representing a position in the array returned by getSources(). This is only available in browsers that support <a title="MediaDevices.enumerateDevices() - Web APIs | MDN" target="_blank" href= "<a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/enumerateDevices"">https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/enumerateDevices"</a> <blockquote>
