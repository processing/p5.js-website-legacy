...
panner__description__1 = Properties include <ul> <li><a title="w3 spec for Panning Model" href="<a href="https://www.w3.org/TR/webaudio/#idl-def-PanningModelType"">https://www.w3.org/TR/webaudio/#idl-def-PanningModelType"</a><blockquote>
