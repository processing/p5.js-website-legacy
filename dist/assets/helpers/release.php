...
if ($_GET['f'] == 'update_lib') {
  ...
  echo '<a href="http://p5js.org/download/new-release.php?f=update_lib">update library version</a><br>';
  echo '<a href="http://p5js.org/download/new-release.php?f=update_p5jseditor">update editor version</a>';
}
?>