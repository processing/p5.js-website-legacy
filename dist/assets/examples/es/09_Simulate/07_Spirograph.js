 ...
 */
var NUMSINES = 20; // cuántas partículas podemos hacer al mismo tiempo?
var sines = new Array(NUMSINES); // un arreglo para almacenar todos los ángulos actuales
var rad; // un valor de radio inicial para la sinusoide central
var i; // una variable contador

// juega con estos valores para entender lo que está pasando:
var fund = 0.005; // la velocidad de la sinusoide central
var ratio = 1; // ¿cuál es el multiplicador de velocidad por cada sinusoide adicional?
var alpha = 50; // cuán opaco es el sistema de trazado

var trace = false; // ¿estamos trazando?
...
function draw() {
  ...
  for (var i = 0; i<sines.length; i++) {
    var erad = 0; // radio del "punto" pequeño dentro del círculo... este es el "lápiz" para trazar
    ...
    var radius = rad/(i+1); // radio del círculo
